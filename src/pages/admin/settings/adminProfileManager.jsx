    ...
    <>
        <div>
            <div className='bg-white md:mb-10'>
                <div>
                    <span className='bg-gray-100 p-2 rounded-r-md text-gray-400'>Personal Information:</span>
                </div>
                <div className='flex flex-col items-center text-gray-400 py-2 mt-5'>
            ...
            <div className='bg-white md:mb-10 my-5'>
                <div>
                    <span className='bg-gray-100 p-2 rounded-r-md text-gray-400'>Change password:</span>
                </div>
                <div className='flex flex-col items-center text-gray-400 py-2 mt-5'>
                    <div>
